...
const ROLES = [
  {
    ...
    steps: [
      ...
      { title: 'Deliver to Google Drive', desc: 'Select a client\'s Drive folder from the project dropdown and upload photos/videos directly to their Google Drive.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Access media via Google Drive', desc: 'Browse your Media Gallery to view photos and videos vendors have uploaded. Click "Open in Google Drive" to download files.' },
  ...
  },
  {
    ...
    intro: 'Clone the repo, set up locally, and contribute code — guided by AI-powered vibe coding.',
    steps: [
      { title: 'Get GitHub & Vercel access', desc: 'Your admin adds you to the GitHub repo and Vercel team. Accept the invite emails.' },
      { title: 'Clone & set up locally', desc: 'Clone the repo, run npm install, copy .env.example, and run npm run db:push + npm run dev.' },
      { title: 'Open Developer Workspace', desc: 'In your portal sidebar, click "Developer Workspace" for quick links, env vars reference, and the full developer guide.' },
      { title: 'Follow the git workflow', desc: 'Never commit to main. Create feature branches (feat/your-feature), typecheck, then open a PR.' },
      { title: 'Complete training', desc: 'Your training page includes a developer-specific guide covering auth patterns, project structure, and vibe coding best practices.' },
      { title: 'Ask for help', desc: 'Check AGENTS.md in the repo, the Knowledge Base, or ask in the dev channel if you get stuck.' },
    ],
  },
  {
    id: 'admins',
    ...
    steps: [
      ...
      { title: 'Link Google Drive to clients', desc: 'Create a Shared Drive folder, share it with the service account, and paste the Folder ID in the client\'s edit form so vendors can deliver files.' },
      ...
      <footer className="border-t border-white/5 py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="text-xs text-white/20">
            ...
            <span className="mx-3">·</span>
            <Link href="/developer" className="hover:text-white/40 transition-colors">Developer</Link>
          </div>
        </div>
      </footer>
    </div>
